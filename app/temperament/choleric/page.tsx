              ...
              {[
                {
                  ...
                  description:
                    'Practice considering others\' perspectives and feelings. True leadership includes caring for team members.',
                },
                {
                  title: 'Learn to Delegate',
                  description:
                    'Trust others with responsibilities. Delegation multiplies your impact and develops your team.',
                },
                {
                  title: 'Practice Patience',
                  description:
                    'Not everything requires immediate action. Reflection and patience lead to better decisions.',
                },
                {
                  title: 'Rest and Recovery',
                  description:
                    'Your drive can lead to burnout. Schedule downtime and recovery to sustain long-term performance.',
                },
              ].map((tip, index) => (
                <div
                  key={index}
                  className="p-6 bg-gray-900 border border-gray-700 rounded-lg hover:border-red-600 transition-all duration-300"
                >
                  <h3 className="text-lg font-bold text-red-500 mb-2">{tip.title}</h3>
